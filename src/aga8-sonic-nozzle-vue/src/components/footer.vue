  ...
  <footer class="bg-gray-100">
    <div class="relative mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8 lg:pt-24">
      ...
      <div class="lg:flex lg:items-end lg:justify-between">
        <div>
          <div class="flex justify-center text-teal-600 lg:justify-start">
            <img class="h-8" src="/logo-long.svg" alt="Aga8">
          </div>
        ...
        >
          <li>
            <a class="text-gray-700 transition hover:text-gray-700/75" href="https://sctg.eu.org/about?lang=en#top"> About </a>
          </li>
    
          <li>
            <a class="text-gray-700 transition hover:text-gray-700/75" href="https://sctg.eu.org/?lang=en#services"> Services </a>
          </li>
      ...
      <p class="mt-12 text-center text-sm text-gray-500 lg:text-right">
        Copyright &copy; 2025 - Ronan Le Meillat - SCTG Development. All rights reserved.
      </p>
    </div>
  </footer>
</template>